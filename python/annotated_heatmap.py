...
if args.pathresults is None:
    args.pathresults = "/informatik2/students/home/5rietz/WTM/io_candidates_stat_cont_new_punish_opt"
...
def create_inner_outer_csv():
    ...
    for hiob_execution in hiob_executions:
        ...
        if inner in list(df["Inner punish threshold"]):
            if outer in list(df.loc[df["Inner punish threshold"] == inner]["Outer punish threshold"]):
                print()
